...
import type { ActiveFilter } from "@/components/shared/SmartInput";
import type { FilterValues } from "@/lib/api";
...
export function FilterSidebarBase({
  filterValues,
  activeFilters,
  onAddFilter,
  onRemoveFilter,
  ...
  return (
    <div className="p-4 space-y-4 text-sm">
      ...
      {/* Extra content (e.g. num_stops slider for routes) */}
      {extraContent}
    </div>
  );
}
