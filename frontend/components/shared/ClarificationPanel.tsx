            ...
            return (
              <div key={`${e.entityType}-${e.value}`}>
                <p className="text-sm text-stone-700">
                  ...
                  {" "}¿Quieres filtrar por <span className="font-medium text-amber-700">{label}</span>?
                </p>
    ...
    <div className="mt-3 space-y-2 animate-in fade-in slide-in-from-top-3 duration-300">
      ...
      <div className="flex items-start gap-2.5">
        <div className="w-6 h-6 rounded-full bg-amber-100 flex items-center justify-center shrink-0 mt-0.5">
          <svg className="w-3.5 h-3.5 text-amber-600" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
