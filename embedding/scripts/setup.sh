...
EMBEDDING_MODEL_DIR="${MONOREPO_ROOT}/backend/models/ALIA-MrBERT-es-cultural-embeddings"
RERANKER_MODEL_DIR="${MONOREPO_ROOT}/backend/models/ALIA-MrBERT-es-cultural-reranker"
