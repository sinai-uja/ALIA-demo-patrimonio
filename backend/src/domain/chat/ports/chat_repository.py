...
class ChatRepository(ABC):
    ...
    @abstractmethod
    async def create_session(self, title: str, user_id: UUID | None = None) -> ChatSession: ...
    ...
    @abstractmethod
    async def list_sessions(self, user_id: UUID | None = None) -> list[ChatSession]: ...

    @abstractmethod
    async def delete_session(self, session_id: UUID, user_id: UUID | None = None) -> None: ...
